...
document.write('<div class="item-thumbnail col-sm-5"><img class="recent_thumb" src="'+thumburl+'"/></div>');
document.write('<div class="item-title col-sm-7"><h4><a href="'+posturl+'" target ="_top">'+posttitle+'</a></h4></div>');
